package com.ecommerce.admin.setting.controller;
...
import com.ecommerce.admin.setting.GeneralSettingBag;
...
public class SettingController {
	...
	public String saveMailServerSettings(HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "Mail server settings have been successfully saved");
	...
	public String saveMailTemplatesSettings(HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "Mail template settings have been successfully saved");
	...
	public String savePaymentSettings(HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "Payment settings have been successfully saved");
